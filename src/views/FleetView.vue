    ...
    return {
      ...
      vehicles: [
        ...
        },
        {
          ...
          category: 'SUV',
          description: 'Robust SUV perfect for family adventures',
          image: 'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=600&h=400&fit=crop&crop=center',
          passengers: 7,
          luggage: 5,
          transmission: 'Automatic',
          ac: true,
          price: 95,
          features: ['7 Seater', 'Durable', 'High Ground Clearance', 'Safety'],
          priceRange: 'mid'
        },
        {
          id: 5,
        ...
        },
        {
          ...
          ac: true,
          price: 90,
          features: ['7 Seater', 'Modern Tech', 'Safety', 'Comfortable'],
          priceRange: 'mid'
        },
        {
          id: 8,
          name: 'Toyota Hilux',
          category: '4x4',
          description: 'Rugged pickup truck for heavy-duty work',
          image: 'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=600&h=400&fit=crop&crop=center',
          passengers: 5,
          luggage: 8,
          transmission: 'Manual',
          ac: true,
          price: 120,
          features: ['Pickup Truck', 'Heavy Duty', '4x4', 'Cargo Space'],
          priceRange: 'luxury'
        },
        {
          id: 9,
          name: 'Toyota Coaster',
          category: '4x4',
          description: 'Large passenger van for group travel',
          image: 'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=600&h=400&fit=crop&crop=center',
          passengers: 16,
          luggage: 12,
          transmission: 'Manual',
          ac: true,
          price: 180,
          features: ['16 Seater', 'Group Travel', 'Large Cargo', 'Comfortable'],
          priceRange: 'luxury'
        }
      ]
    }
