<template>
  <div class="culture-heritage-page">
    <SEOHead
      title="Rwanda Culture & Heritage - Traditional Dance, Arts & Traditions | Kigali SelfDrive"
      description="Discover Rwanda's rich cultural heritage, from traditional Intore dance to ancient crafts and modern arts. Experience the vibrant culture of the Land of a Thousand Hills."
      keywords="rwanda culture, rwanda heritage, intore dance, rwandan traditions, rwanda arts, rwanda crafts, traditional rwanda"
      url="https://kigaliselfdrive.com/about-rwanda/culture-heritage"
    />
    ...
    <!-- Arts & Crafts Section -->
    <section class="arts-section section-dominant">
      <div class="container">
        <h2 class="section-title text-secondary">Traditional Arts & Crafts</h2>
        <div class="arts-grid">
    ...
    <section class="language-section bg-dominant-dark">
      <div class="container">
        <h2 class="section-title text-secondary">Language & Communication</h2>
    ...
    <section class="festivals-section bg-dominant-dark">
      <div class="container">
        <h2 class="section-title text-secondary">Festivals & Celebrations</h2>
    ...
    <section class="modern-section section-dominant">
      <div class="container">
        <h2 class="section-title text-secondary">Modern Rwandan Culture</h2>
    ...
    <section class="values-section section-dominant">
      <div class="container">
        <h2 class="section-title text-secondary">Rwandan Cultural Values</h2>
    ...
    <section class="cta">
      <div class="container">
        <div class="cta-content">
          <h2>Experience Rwanda's Rich Culture</h2>
          <p>Book your car today and immerse yourself in the authentic culture of Rwanda</p>
