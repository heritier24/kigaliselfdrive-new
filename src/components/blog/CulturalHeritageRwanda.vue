<template>
  <div class="blog-detail-page">
    <SEOHead
      title="Rwanda's Cultural Heritage: Must-Visit Sites | Kigali SelfDrive"
      description="Immerse yourself in Rwanda's rich cultural heritage through visits to traditional villages, museums, and historical sites. Your complete guide to Rwanda's cultural treasures."
      ...
      <div class="hero-content">
        <div class="container">
          <div class="article-meta">
            <span class="category">Rwanda Tourism</span>
        ...
        <div class="content-wrapper">
          ...
          <div class="main-content">
            ...
            <div class="content-section">
              ...
              <div class="heritage-overview">
                ...
                <div class="overview-card">
                  ...
                  <p>Dance, music, crafts, and storytelling traditions</p>
                </div>
                <div class="overview-card">
                  <h4>🏺 Cultural Practices</h4>
                  <p>Traditional ceremonies, rituals, and social customs</p>
                </div>
                <div class="overview-card">
                  <h4>🌱 Modern Identity</h4>
                  <p>Post-genocide reconciliation and nation-building</p>
                </div>
              </div>
            </div>
            ...
            <div class="content-section">
              ...
              <div class="etiquette-guide">
                ...
                <div class="etiquette-card">
                  <h4>🏛️ Visiting Cultural Sites</h4>
                  <ul>
                    <li>Remove shoes when entering traditional homes</li>
                    <li>Follow local customs and traditions</li>
                    <li>Listen to guides and respect their knowledge</li>
                    <li>Don't touch artifacts or sacred objects</li>
                  </ul>
                </div>
                <div class="etiquette-card">
                  <h4>💬 Communication</h4>
                  <ul>
                    <li>Learn basic Kinyarwanda phrases</li>
                    <li>Speak respectfully and avoid sensitive topics</li>
                    <li>Be patient with language barriers</li>
                    <li>Show interest in local culture and traditions</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="sidebar">
            <div class="sidebar-widget">
              <h3>Cultural Sites Checklist</h3>
              <div class="checklist">
                ...
                <div class="checklist-item">
                  <span class="check">✅</span>
                  <span>Nyanza Royal Palace</span>
                </div>
                <div class="checklist-item">
                  <span class="check">✅</span>
                  <span>Ethnographic Museum</span>
                </div>
                <div class="checklist-item">
                  <span class="check">✅</span>
                  <span>Iby'Iwacu Cultural Village</span>
                </div>
                <div class="checklist-item">
                  <span class="check">✅</span>
